...
** Fcitx
   ...
   Unfortunately, the current version of it requires =evil-mode=,
   which I don't use.  I have a patched version that I'm submitting,
   but until it is in, we have to include it separately.
